...
import "goods_pictures.dart";
import "goods_skus.dart";
...
class Product {
  ...
  final List<GoodsPictures> goodsPictures;
  ...
  Product copyWith({
    ...
    int height,
    String supplierId,
    List<GoodsPictures> goodsPictures,
  ...
  factory Product.fromMap(Map<String, dynamic> map) {
    ...
    return Product(
      ...
      goodsPictures: List<GoodsPictures>.from(
          map['goodsPictures']?.map((x) => GoodsPictures.fromMap(x))),
